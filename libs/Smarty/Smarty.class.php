...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('.' . DS . TPL . DS)
            ->setCompileDir('.' . DS .LIBDATA.'Smarty/templates_c/' . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir('.' . DS . LIBDATA.'Smarty/cache' . DS)
            ->setConfigDir('.' . DS . LIBDATA.'Smarty/configs' . DS);
